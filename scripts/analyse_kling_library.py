    ...
    content = [
        {
            ...
            "text": (
                ...
                "CRITICAL RULES — apply all, no exceptions:\n"
                "1. If ANY animal appears in ANY frame → best_use='avoid'.\n"
                "2. If the shot is an extreme face close-up (face fills most of the frame, "
                "upward-tilted face, face-up pose, tight portrait with no body/setting visible) "
                "→ best_use='avoid' and boothop_fit <= 3.\n"
                "3. Wide and medium shots showing people in action score higher on boothop_fit.\n\n"
